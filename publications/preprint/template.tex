...
\renewcommand{\maketitlehookd}{%
	\begin{abstract}
          ...
          of this system, which has potential applications in parsing and self-modifying systems.
        \end{abstract}
}
...
\emph{simulate} reading ahead, and allow for metaprogramming; third, it uses what we call an \emph{falias} system which we
believe to be computationally equivalent to metacrank, but makes for easier bootstrapping to an environment that is more
desirable to program in.
