...
# 105 "include/stem.h" 3 4
_Bool 
# 105 "include/stem.h"
    ht_exists(ht_t *h, string_t *key);
...
# 111 "include/stem.h" 3 4
_Bool 
# 111 "include/stem.h"
    eval_builtins(value_t *v);


# 113 "include/stem.h" 3 4
_Bool 
# 113 "include/stem.h"
    eval_ht(value_t *v);


# 115 "include/stem.h" 3 4
_Bool 
# 115 "include/stem.h"
    eval_quote(value_t *v);

void eval(value_t *v);
# 4 "include/builtins.h" 2
...
char *get_line(FILE *f) {
  int len = 1000;
  char buf[1000], *e = 
# 32 "src/builtins.c" 3 4
                     ((void *)0)
# 32 "src/builtins.c"
                         , *ret;
  if (!(ret = calloc(1000, 1))) { perror("ret = calloc(MAX, 1)"); exit(1); };
  while (fgets(buf, 1000, f)) {
    if (len - strlen(ret) < 1000)
      if (!(ret = realloc(ret, len *= 2))) { perror("ret = realloc(ret, len *= 2)"); exit(1); };
    strcat(ret, buf);
    if ((e = strrchr(ret, '\n')))
      break;
  }
...
void clib(value_t *v) {
  value_t *v1 = array_pop(STACK);
  void *handle = dlopen(v1->str_word->value, 
# 749 "src/builtins.c" 3 4
                                            0x00001
# 749 "src/builtins.c"
                                                     );
  if (!handle) {
  ...
  *(void **)(&aobjs) = dlsym(handle, "add_objs");
  if ((error = dlerror()) != 
# 761 "src/builtins.c" 3 4
                            ((void *)0)
# 761 "src/builtins.c"
                                ) {
    value_free(v1);
    fprintf(
# 763 "src/builtins.c" 3 4
           stderr
# 763 "src/builtins.c"
                 , "%s\n", error);
    eval_error();
