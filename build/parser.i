...
# 111 "include/parser.h" 3 4
_Bool 
# 111 "include/parser.h"
    eval_builtins(value_t *v);


# 113 "include/parser.h" 3 4
_Bool 
# 113 "include/parser.h"
    eval_ht(value_t *v);


# 115 "include/parser.h" 3 4
_Bool 
...
# 153 "src/parser.c" 3 4
                           ((void *)0)
# 153 "src/parser.c"
                               );
  
# 154 "src/parser.c" 3 4
 _Bool 
# 154 "src/parser.c"
      escaped = 
# 154 "src/parser.c" 3 4
...
value_t *parse_word(parser_t *p) {
  ...
  string_t *s = init_string(
# 212 "src/parser.c" 3 4
                           ((void *)0)
# 212 "src/parser.c"
                               );
  if (p->c == '\\') {
    retv->escaped = 
# 214 "src/parser.c" 3 4
                   1
# 214 "src/parser.c"
                       ;
    parser_move(p);
    if (
# 216 "src/parser.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 216 "src/parser.c"
       p->c
# 216 "src/parser.c" 3 4
...
value_t *parse_num(parser_t *p) {
  value_t *retv;
  string_t *s = init_string(
# 230 "src/parser.c" 3 4
                           ((void *)0)
# 230 "src/parser.c"
                               );
  
# 231 "src/parser.c" 3 4
 _Bool 
# 231 "src/parser.c"
      is_float = 
# 231 "src/parser.c" 3 4
...
_Bool 
# 382 "src/parser.c"
    ht_exists(ht_t *h, string_t *key) { return ht_get(h, key) != 
# 382 "src/parser.c" 3 4
                                                                 ((void *)0)
# 382 "src/parser.c"
                                                                     ; }
