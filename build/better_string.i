...
# 6 "src/better_string.c"
string_t *init_string(char *s) {
  string_t *str = malloc(sizeof(string_t));
  if (str == 
# 8 "src/better_string.c" 3 4
            ((void *)0)
# 8 "src/better_string.c"
  ...
  if (s == 
# 12 "src/better_string.c" 3 4
          ((void *)0) 
# 12 "src/better_string.c"
               || strcmp(s, "") == 0) {
    str->bufsize = 10;
    str->value = calloc(str->bufsize, sizeof(char));
    str->value[0] = '\0';
    if (str->value == 
# 16 "src/better_string.c" 3 4
                     ((void *)0)
# 16 "src/better_string.c"
                         )
  ...
  str->value = calloc(str->bufsize, sizeof(char));
  if (str->value == 
# 25 "src/better_string.c" 3 4
                   ((void *)0)
# 25 "src/better_string.c"
                       )
    die("calloc in init_string");
  strcpy(str->value, s);
  return str;
...
void *realloc_zero(void *pBuffer, size_t oldSize, size_t newSize) {
  ...
  if (pNew == 
# 36 "src/better_string.c" 3 4
             ((void *)0)
# 36 "src/better_string.c"
                 )
